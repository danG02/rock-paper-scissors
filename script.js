...
const win = (playerChoice, computerChoice) => {
    ...
    result_p.innerHTML = ` You picked ${convertToWord(playerChoice)}, ${convertToWord(playerChoice)} beats ${convertToWord(computerChoice)}. You Win!`;
...
const lose = (playerChoice, computerChoice) => {
    ...
    playerScore_span.innerHTML = playerScore;
    computerScore_span.innerHTML = computerScore;
    result_p.innerHTML = ` You picked ${convertToWord(playerChoice)}, ${convertToWord(playerChoice)} loses to ${convertToWord(computerChoice)}. You Lose...`;
...
const draw = (playerChoice, computerChoice) => {
    playerScore_span.innerHTML = playerScore;
    computerScore_span.innerHTML = computerScore;
    result_p.innerHTML = `You both picked ${convertToWord(playerChoice)} and ${convertToWord(computerChoice)}. Its a Draw!`;
